            ...
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[500px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                <h3 className="mb-3 text-center text-2xl font-bold text-black dark:text-white sm:text-3xl">
                  Criar Conta - Sistema de Aluguel
                </h3>
                <p className="mb-11 text-center text-base font-medium text-body-color">
                  Registre-se para acessar o sistema de aluguel de carros
                </p>
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mb-8">
                    ...
                    >
                      ...
                      <option value="ROLE_CLIENT">Cliente Individual</option>
                      <option value="ROLE_COMPANY">Empresa</option>
                      <option value="ROLE_BANK">Banco</option>
                    </select>
                    {errors.role && (
                  ...
                  <div className="mb-8">
                    ...
                    <input
                      type="text"
                      {...register("employer")}
                      placeholder="Digite seu empregador (opcional)"
                      className="border-stroke dark:text-body-color-dark dark:shadow-two w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
                    />
                  </div>
